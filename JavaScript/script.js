...
//3fc98b634c8b4a178a9d0128d82cb953 -Andrei
const apiKey = '8230bdcad5844a3a950a03424418c2b8';
//8230bdcad5844a3a950a03424418c2b8 -Matei
    ...
    getNews().then(data => {
        ...
        if (data && data.articles) {
            ...
            for (var i = 0; i < data.articles.length; i++) {
                var news = data.articles[i].title;
                console.log("CEAU")
                console.log(news);
...
const getNews = async () => {
    try {
        ...
        localStorage.setItem('stiri', JSON.stringify(data.articles))
        return data;
    } catch (error) {
